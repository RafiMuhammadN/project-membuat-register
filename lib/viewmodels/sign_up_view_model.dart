    ...
    try{
      if (nameController.text.length != null &&
        ...
        if (data.code == 200){
          ...
          setBusy(false);
          _alertService.showAlert(context, 'Error', 'Something went Wrong', _navigationService.pop);
        }
      } else {
        setBusy(false);
        _alertService.showAlert(context, 'Warning', 'Please fill al dield', _navigationService.pop);
      }
    } catch (e){
